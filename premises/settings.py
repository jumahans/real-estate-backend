...
SECRET_KEY = 'django-insecure-m0zek1twsjfahyn&hsk1dngm_=v^v))u0h%ls*3&$4j_8$_d2p'
...
# Replace your entire EMAIL block with this
...
# FORCE single boolean (fixes cache)
EMAIL_USE_TLS = True   # Gmail 587
